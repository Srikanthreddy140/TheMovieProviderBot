...
BOT_TOKEN = environ.get('BOT_TOKEN', "7019944285:AAG4y59znDcjYnR1XyDClpUIxvotECx6CuY")
...
STREAM_SITE = (environ.get('STREAM_SITE', 'tulinks.in'))
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ROYALBOMMA')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002177822418')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002177822418'))
