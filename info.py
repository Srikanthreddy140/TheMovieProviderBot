...
PICS = (environ.get('PICS', 'https://graph.org/file/bfa216f5ee326c634de30.jpg https://graph.org/file/93a262fad44b9b6d4a6ff.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/93a262fad44b9b6d4a6ff.jpg")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://armnmd639:armnmd639@cluster0.54pgwjy.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "saloni0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+LueCvBO7lSJhNzNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+oMz1VPb7pCI1MjU8')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002014827868'))
